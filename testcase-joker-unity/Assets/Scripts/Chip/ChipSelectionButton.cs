...
public class ChipSelectionButton : MonoBehaviour
{
    ...
    /// <param name="chipSelectionController">The controller that handles the chip selection.</param>
    /// <param name="chipModel">The model of the chip.</param>
    public void Initialize(ChipValue value, ChipSelectionController chipSelectionController, GameObject chipModel)
    {
        Value = value;
